...
import { merge } from '../build/debug.js';
...
describe('cidr-tools-wasm', () => {
  ...
  //   expect(exclude(['1.0.0.0/24'], ['1.0.0.0'])).to.eql(['1.0.0.1/32', '1.0.0.2/31', '1.0.0.4/30', '1.0.0.8/29', '1.0.0.16/28', '1.0.0.32/27', '1.0.0.64/26', '1.0.0.128/25']);
  //   expect(exclude(['10.11.0.0/16'], ['10.11.70.0/24'])).to.eql(['10.11.0.0/18', '10.11.64.0/22', '10.11.68.0/23', '10.11.71.0/24', '10.11.72.0/21', '10.11.80.0/20', '10.11.96.0/19', '10.11.128.0/17']);
